let guestList: string[] = ["Alishba", "Rohma", "Laiba", "Faiza"];
...
while (guestList.length > 2) {
  ...
  console.log(
    `Dear ${removedGuest}, I'm so sorry, but I can't invite you to dinner. Maybe next time!`
  );
}
...
guestList.forEach((guest) => {
  console.log(
    `Dear ${guest}, you're still invited to dinner! I'm looking forward to seeing you.`
  );
});
